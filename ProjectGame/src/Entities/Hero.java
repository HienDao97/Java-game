...
public class Hero extends GameObjectDynamic {
    ...
    public Hero(int x,int y) { 
         super(x,y);
         fires = new ArrayList<>(); 
         loadImage("res/textures/img/ironman.png");
         getImageDimension();
    }
    public void move() {
    	x +=dx;
    ...
    public void keyPressed(KeyEvent e) {
	   ...
	   if (key == KeyEvent.VK_LEFT)  { dx = -1; loadImage("res/textures/img/ironmanleft.png") ; setDirect(-1);}
	   if (key == KeyEvent.VK_RIGHT) { dx =  1; loadImage("res/textures/img/ironmanright.png") ; setDirect(1) ;}
	   if (key == KeyEvent.VK_UP)    { dy = -1; loadImage("res/textures/img/ironmanup.png") ; setDirect(2) ;} 
	   if (key == KeyEvent.VK_DOWN)  { dy =  1; loadImage("res/textures/img/ironman.png") ; setDirect(-2);}    	
    }
